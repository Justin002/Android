 ...
 *
 */
public class CommunitySecondListAdapter extends BaseAdapter {
	...
	public CommunitySecondListAdapter(Context context, Handler handler,int type) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (null == convertView) {
			...
			convertView = inflater.inflate(R.layout.item_community_secondlist, null);
