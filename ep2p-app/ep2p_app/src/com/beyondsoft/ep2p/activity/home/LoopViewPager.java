...
import com.beyondsoft.ep2p.activity.home.adapter.LoopPagerAdapterWrapper;
...
public class LoopViewPager extends ViewPager
{
    ...
    private void addDot()
    {
        if (dotParent != null)
        {
            Logs.d("PagerAWrapper:"+mAdapter.getCount());
    ...
    public boolean dispatchTouchEvent(MotionEvent event)
    {
        ...
        else if (event.getAction() == MotionEvent.ACTION_DOWN)  //#TODO 按下不停止滚动
        {
            // 停止图片滚动
            stopImageTimerTask();
        }
