 ...
 *
 */
public class WaittingRecieveDoneDetailActivity extends BaseActivity implements OnClickListener {
	...
	public static final int FLAG_GET_DONE_RECEIVE_DETAIL = 100;
	...
	private LinearLayout ll_project_detail, ll_creditor_rights_transf, item_wait_income_amount,amount_detail,ll_qici;

	private TextView tv_borrowCode,tv_borrowName,tv_totalAmount,tv_capital,tv_netInterest,tv_netHike,tv_yuqipeifu,tv_qici,tv_expireTime,totalAmont_describe;
	...
	private void getWaitReceiveDetail(){
		...
		connection(baseService.getStringRequest(FLAG_GET_DONE_RECEIVE_DETAIL,URL.URL_WAIT_RECEIVE_DETAIL, params, mContext));
	}
	...
	//	ll_creditor_rights_transf.setOnClickListener(this);
		ll_qici = (LinearLayout) findViewById(R.id.ll_qici);
		...
		totalAmont_describe = (TextView) findViewById(R.id.totalAmont_describe);
		totalAmont_describe.setText("已收金额");
	...
	public void onResponse(int tag, Object values) {
		...
		switch(tag)
		{
		case FLAG_GET_DONE_RECEIVE_DETAIL:
