 ...
 *
 */
public class CreditorRightsHaveAdapter extends BaseAdapter {
	...
	public CreditorRightsHaveAdapter(Context context, Handler handler) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (null == convertView) {
			...
			convertView = inflater.inflate(R.layout.item_creditor_rights_have_item, null);
