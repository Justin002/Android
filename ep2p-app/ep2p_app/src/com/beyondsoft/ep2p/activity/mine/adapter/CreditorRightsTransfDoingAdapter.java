 ...
 *
 */
public class CreditorRightsTransfDoingAdapter extends BaseAdapter {
	...
	public CreditorRightsTransfDoingAdapter(Context context, Handler handler) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (null == convertView) {
			...
			convertView = inflater.inflate(R.layout.item_creditor_rights_transf_doing_item, null);
