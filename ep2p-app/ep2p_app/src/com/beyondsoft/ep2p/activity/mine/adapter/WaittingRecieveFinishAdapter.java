 ...
 *
 */
public class WaittingRecieveFinishAdapter extends BaseAdapter {
	...
	public WaittingRecieveFinishAdapter(Context mContext, ArrayList<WaitReceiveInfoBean> list) {
		super();
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (null == convertView) {
			...
			convertView = inflater.inflate(R.layout.item_waitting_recieve_finish_item, null);
