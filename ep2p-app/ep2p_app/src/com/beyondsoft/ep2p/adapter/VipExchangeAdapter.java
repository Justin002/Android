...
public class VipExchangeAdapter extends BaseAdapter{

	private List<ExchangeDetail> mInviteList;
	private LayoutInflater layoutInflater;
	
	public VipExchangeAdapter(Context context){
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(convertView==null){
			...
			if(type==0){
				convertView=layoutInflater.inflate(R.layout.vip_exchange_item_top,null);
			}else{
				convertView=layoutInflater.inflate(R.layout.vip_exchange_item,null);
			}
		...
		viewHolder.tv_vip_year.setText(StringUtils.formatYear(vipDetail.getDictContName()));
