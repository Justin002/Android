...
public class TimeUtil {
    ...
    public static String get2Time2(long time) {
	...
	// currentTime要转换的long类型的时间
	// formatType要转换的string类型的时间格式
	public static String longToSimpleString(long currentTime) {
		String am="PM";
		...
		String date=(calendar.get(Calendar.DATE)+1)+"";
		...
		return year+"-"+month+"-"+date+" "+hour_str+":"+minute_str+am;
	}
