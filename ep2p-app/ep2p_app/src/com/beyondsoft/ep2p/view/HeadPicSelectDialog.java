 ...
 *
 */
public class HeadPicSelectDialog extends Dialog {
	...
	public HeadPicSelectDialog(Context con) {
		super(con);
		this.context = con;
	}

	public HeadPicSelectDialog(Context con, int theme) {
		super(con, theme);
		this.context = con;
	}
	...
	private void initView() {
		...
		lp.height=(int) (0.5 * dm.heightPixels);
