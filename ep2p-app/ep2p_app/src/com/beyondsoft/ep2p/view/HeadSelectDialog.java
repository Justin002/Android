...
public class HeadSelectDialog extends Dialog {
	...
	private HeadSelectDialogOnClickListener listener;

	public interface HeadSelectDialogOnClickListener {
	...
	public HeadSelectDialog(Context con) {
		super(con);
		this.context = con;
	}

	public HeadSelectDialog(Context con, int theme) {
		super(con, theme);
		this.context = con;
	}
	...
	private void initView() {
		setContentView(R.layout.dialog_headportrait);
		tv_title = (TextView) findViewById(R.id.tv_cancel);
		tv_take_photo = (TextView) findViewById(R.id.tv_pick_photo);
		tv_select_picture = (TextView) findViewById(R.id.tv_photos);
	...
	public void setButtonClickListener(HeadSelectDialogOnClickListener listener) {
