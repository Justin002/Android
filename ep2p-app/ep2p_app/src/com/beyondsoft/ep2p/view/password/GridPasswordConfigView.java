...
public class GridPasswordConfigView extends LinearLayout implements PasswordYanView {
    ...
    public GridPasswordConfigView(Context context) {
        this(context, null);
    }

    public GridPasswordConfigView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public GridPasswordConfigView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initAttrs(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        textColor = ta.getColorStateList(R.styleable.gridPasswordView_pwtextColor);
        if (textColor == null)
