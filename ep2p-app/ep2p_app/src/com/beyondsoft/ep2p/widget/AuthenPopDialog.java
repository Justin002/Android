...
public class AuthenPopDialog extends Dialog{
	private Button button1;
	private Button button2;
	private TextView app_dialog_descri;
	private TextView app_dialog_title;
	private Context ctx;
	private AuthenButtonOnClickListener listener;
	
	public interface AuthenButtonOnClickListener{
		void onButton1Click(View v);
		void onButton2Click(View v);
	}
	
	public AuthenPopDialog(Context context) {
		super(context);
		this.ctx = context;
	}
	
	public AuthenPopDialog(Context context, int theme) {
		super(context,theme);
		this.ctx = context;
	}
	...
	public void setButtonClickListener(AuthenButtonOnClickListener listener){
